    ...
    if NumberOfDices == 1:
        ...
        if dices[0] == dices[1]:
            if dices[0] == 1:
                ...
                return 100
        elif dices[0] == 1 or 5 and dices[1] == 1 or 5:
            return 150
        ...
        if dices[0] == dices[1] == dices[2] == dices[3] == dices[4] == dices[5]:
            if dices[0] == 1:
                ...
                return dices[1]*800
        #dvojice
        elif dices[0] == dices[1] and dices[2] == dices[3] and dices[4] == dices[5] and dices[0] != dices[2] and dices[2] != dices[4]:
            return 1000
        #postupka
        ...
        #pětice + 5
        elif dices[0] == dices[1] == dices[2] == dices[3] == dices[4] and dices[5] == 5 or dices[5] == dices[1] == dices[2] == dices[3] == dices[4] and dices[0] == 5:
            #pětice 1 + 5
            if dices[0] == 1:
                return 4050
            #pětice + 5
        ...
        #čtveřice + 1 + 5
        elif dices[4] == dices[5] == dices[2] == dices[3] and dices[0] == 1 and dices[1] == 5 or dices[4] == dices[1] == dices[2] == dices[3] and dices[0] == 1 and dices[5] == 5:
            return dices[2]*200+150
        #trojce + dvojice 1 + 5
        elif dices[0] == dices[1] == 1 and dices[2] == 5 and dices[3] == dices[4] == dices[5] or dices[0] == dices[1] == 1 and dices[5] == 5 and dices[3] == dices[4] == dices[2]:
