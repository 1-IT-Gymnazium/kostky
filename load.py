    ...
    if NumberOfDices == 1:
        ...
        # trojice + dvojice 1/5
            ...
            # trojice + dvojice 5
                ...
                return dices[0] * 100 + 100
        # trojice + 1 + 5
        elif dices[3] == dices[4] == dices[2] and dices[0] == 1 and dices[1] == 5 or dices[3] == dices[1] == dices[
            2] and dices[0] == 1 and dices[4] == 5:
        ...
        if dices[0] == dices[1] == dices[2] == dices[3] == dices[4] == dices[5]:
            if dices[0] == 1:
                ...
                return dices[1] * 800
        # dvojice
        elif dices[0] == dices[1] and dices[2] == dices[3] and dices[4] == dices[5] and dices[0] != dices[2] and dices[
            2] != dices[4]:
            return 1000
        # postupka
        elif dices[0] == dices[1] - 1 == dices[2] - 2 == dices[3] - 3 == dices[4] - 4 == dices[5] - 5:
            return 1500
        # dvě trojice
        elif dices[0] == dices[1] == dices[2] and dices[3] == dices[4] == dices[5]:
            # trojice 1 a trojice
            if dices[0] == 1:
        ...
        # pětice + 5
        elif dices[0] == dices[1] == dices[2] == dices[3] == dices[4] and dices[5] == 5 or dices[5] == dices[1] == \
                dices[2] == dices[3] == dices[4] and dices[0] == 5:
            # pětice 1 + 5
            if dices[0] == 1:
                return 4050
            # pětice + 5
        ...
        # pětice + 1
        elif dices[5] == dices[1] == dices[2] == dices[3] == dices[4] and dices[0] == 1:
            return dices[1] * 400 + 50
        # čtveřice + dvojice 5
        elif dices[0] == dices[1] == dices[2] == dices[3] and dices[4] == dices[5]:
            if dices[0] == 1:
                return 2100
        # čtveřice + dvojice 1/5
        elif dices[4] == dices[5] == dices[2] == dices[3] and dices[0] == dices[1]:
            # čtveřice + dvojice 1
            if dices[0] == 1:
        ...
        # čtveřice + 1 + 5
        elif dices[4] == dices[5] == dices[2] == dices[3] and dices[0] == 1 and dices[1] == 5 or dices[4] == dices[1] == \
                dices[2] == dices[3] and dices[0] == 1 and dices[5] == 5:
            return dices[2] * 200 + 150
        # trojce + dvojice 1 + 5
        elif dices[0] == dices[1] == 1 and dices[2] == 5 and dices[3] == dices[4] == dices[5] or dices[0] == dices[
            1] == 1 and dices[5] == 5 and dices[3] == dices[4] == dices[2]:
            return dices[3] * 100 + 250
        # trojce + dvojice 5 + 1
        elif dices[0] == 1 and dices[1] == dices[2] == 5 and dices[3] == dices[4] == dices[5] or dices[0] == 1 and \
                dices[1] == dices[2] == dices[3] and dices[4] == dices[5] == 5:
